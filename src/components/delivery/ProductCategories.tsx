                  ...
                  <div className="mt-auto pt-2 flex flex-col items-center gap-2">
                    ...
                    <div className="flex justify-center w-full">
                      {cartQty > 0 ? (
                         ...
                         <button
                            className="bg-primary hover:bg-primary/90 text-primary-foreground rounded-full flex items-center justify-center transition-colors w-2.5 h-2.5 sm:w-5 sm:h-5"
                           onClick={(e) => {
                             e.stopPropagation();
                             if (selectedVariant) {
                               onAddToCart({
