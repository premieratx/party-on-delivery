  ...
  return (
    ...
    >
      ...
      <div className={`flex flex-col flex-1 justify-between ${
        ...
        {/* Price and cart controls container - FIXED HORIZONTAL ALIGNMENT */}
              ...
              >
                <Button
                  ...
                  onClick={(e) => {
                    ...
                    console.log('🛒 Decrement quantity:', product.id, variantId);
                ...
                <Button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    const variantId = selectedVariant?.id || product.variants[0]?.id;
                    console.log('🛒 Increment quantity:', product.id, variantId);
                    onQuantityChange(String(product.id), variantId ? String(variantId) : undefined, 1);
                  }}
                >
