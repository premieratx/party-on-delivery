          ...
          <div className="mt-auto">
            ...
            {quantity > 0 ? (
              <div className="flex items-center justify-center gap-1 w-full mx-auto max-w-[39px] md:max-w-[80px]">
                ...
                <span className="font-medium min-w-[12px] md:min-w-[16px] text-center text-[10px] md:text-[10px] flex items-center justify-center">
                  {quantity}
                </span>
                <Button
                  variant="outline"
              ...
              <div className="flex justify-center">
                <button
                  onClick={onAddToCart}
                  className="bg-primary hover:bg-primary/90 text-primary-foreground rounded-full w-[14px] h-[14px] md:w-[17px] md:h-[17px] flex items-center justify-center"
                >
