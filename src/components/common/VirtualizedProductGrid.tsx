            ...
            {quantity > 0 ? (
              <div className="flex items-center justify-center gap-1 w-full mx-auto max-w-[80px]">
                <Button
                  ...
                  size="sm"
                  onClick={onDecrement}
                  className="h-1.5 w-1.5 md:h-5 md:w-5 p-0 flex-shrink-0 rounded-full"
                >
                  <Minus className="h-1.5 w-1.5 md:h-2.5 md:w-2.5" />
                </Button>
                ...
                <Button
                  ...
                  className="h-1.5 w-1.5 md:h-5 md:w-5 p-0 flex-shrink-0 rounded-full"
                >
                  <Plus className="h-1.5 w-1.5 md:h-2.5 md:w-2.5" />
                </Button>
              </div>
            ) : (
