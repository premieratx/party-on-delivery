...
const CustomerAuth = () => {
  ...
  const handleSuccessfulAuth = async (userEmail: string) => {
    try {
      ...
      // Clear any previous auth processed flags to prevent loops
      ...
      toast.error('Login successful but there was an issue redirecting. Please try again.');
      setIsLoading(false);
    }
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-4">
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div className="absolute top-1/3 right-1/4 w-64 h-64 bg-yellow-500 rounded-full mix-blend-multiply filter blur-xl animate-pulse animation-delay-2000"></div>
