                        ...
                        {quantity > 0 ? (
                           <div className="flex items-center justify-between bg-primary text-primary-foreground rounded-lg p-0.5 min-w-[55px] sm:min-w-[70px] md:min-w-[90px]">
                             <Button
                               ...
                               className="h-2 w-2 sm:h-3 sm:w-3 md:h-6 md:w-6 p-0 hover:bg-primary-foreground/20 rounded-full"
                             >
                               <Minus className="w-1.5 h-1.5 sm:w-2 sm:h-2 md:w-3 md:h-3" />
                             </Button>
                             ...
                             <Button
                               ...
                               className="h-2 w-2 sm:h-3 sm:w-3 md:h-6 md:w-6 p-0 hover:bg-primary-foreground/20 rounded-full"
                             >
                               <Plus className="w-1.5 h-1.5 sm:w-2 sm:h-2 md:w-3 md:h-3" />
                             </Button>
                           </div>
                        ) : (
                           <Button
                             onClick={() => handleAddToCart(product)}
                             className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-8 md:h-8 rounded-full bg-primary hover:bg-primary/90 text-primary-foreground flex items-center justify-center p-0"
                             size="sm"
                           >
                             <Plus className="w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4" strokeWidth={4} />
                           </Button>
                         )}
                      </div>
                    </div>
