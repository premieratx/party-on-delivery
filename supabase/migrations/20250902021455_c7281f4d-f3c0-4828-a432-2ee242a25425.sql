...
DROP TRIGGER IF EXISTS completed_order_sync_trigger ON customer_orders;
CREATE TRIGGER completed_order_sync_trigger
  AFTER INSERT OR UPDATE ON customer_orders
  FOR EACH ROW
  EXECUTE FUNCTION trigger_completed_order_sync();
